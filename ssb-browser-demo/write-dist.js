...
rimraf("dist", function () {
  ...
  fs.copyFileSync('assets/targetlogic.js', 'dist/js/targetlogic.js')
  fs.copyFileSync('assets/modernizr-3.5.0.min.js', 'dist/js/modernizr-3.5.0.min.js')
  // other
  ...
  fs.copyFileSync('archerlog.png', 'dist/archerlog.png')
  fs.copyFileSync('favicon.ico', 'dist/favicon.ico')
  fs.copyFileSync('assets/noavatar.svg', 'dist/assets/noavatar.svg')
  fs.copyFileSync('assets/start.svg', 'dist/assets/start.svg')
  fs.copyFileSync('assets/play.svg', 'dist/assets/play.svg')
  fs.copyFileSync('assets/pause.svg', 'dist/assets/pause.svg')
  fs.copyFileSync('assets/end.svg', 'dist/assets/end.svg')
