  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>70/85</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
  ...
  var isResponse = opts.isResponse || <span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >fu</span>nction (value) { <span class="cstat-no" title="statement not covered" >return !isRequest(value) </span>}</span>
  var isQuery = opts.isQuery || <span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >fu</span>nction () { <span class="cstat-no" title="statement not covered" >return true </span>}</span>
  var process = opts.process || <span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >fu</span>nction (k, v, cb) { <span class="cstat-no" title="statement not covered" >cb (null, v) </span>}</span>
    ...
    createStream: function (peerId) {
      return {
        source: function (end, cb) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if(end) {
<span class="cstat-no" title="statement not covered" >            for(var k in state) {</span>
<span class="cstat-no" title="statement not covered" >              delete state[k].respondedTo[peerId]</span>
<span class="cstat-no" title="statement not covered" >              delete state[k].requestedFrom[peerId]</span>
            }
<span class="cstat-no" title="statement not covered" >            return</span>
          }
        ...
        sink: function (read) {
          read(null, function more (end, data) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if(end) {
<span class="cstat-no" title="statement not covered" >              for(var k in state) {</span>
<span class="cstat-no" title="statement not covered" >                delete state[k].requestedBy[peerId]</span>
              }
...
<span class="cstat-no" title="statement not covered" >              return</span>
            ...
            for(var k in data) {
              ...
              <span class="missing-if-branch" title="if path not taken" >I</span>if(!isQuery(k) || !(isRequest(value) || isResponse(value, k)))
                ;
              ...
              else <span class="missing-if-branch" title="else path not taken" >E</span>if(isResponse(data[k])) {
...
&nbsp;
    query: function (k, cb) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if(state[k]) {
<span class="cstat-no" title="statement not covered" >        if(state[k].state == STATES.processed) <span class="cstat-no" title="statement not covered" >cb(null, state[k].value)</span></span>
        else <span class="cstat-no" title="statement not covered" >(localCbs[k] = localCbs[k] || []).push(cb)</span>
      }
      else {
        update = true
     ...
     <span class="missing-if-branch" title="else path not taken" >E</span>if(update) next()
    },
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sun Feb 10 2019 13:21:32 GMT+1300 (NZDT)
</div>
</div>
