...
// Stat data
// POUNCH I moved this out to make it a global.
var stats = {
  totalPoints: 0,
  averageScore: 0,
  averageVariance: 0,
...
function logShot() {
  ...
  var newShot = new Shot(currentShot.index, currentShot.score, currentShot.coords, currentShot.variance);
	log.push(newShot);
  //var markdownEditors = document.getElementsByClassName('markdown-editor');
  //console.log("***** markdownEditors.length == " + markdownEditors.length);
  //var markdownForm = markdownEditors[0];
  //markdownForm.innerHTML += currentShot.index + "<br />";
